// Web05Dlg.cpp : implementation file
//
...
CWeb05Dlg::CWeb05Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CWeb05Dlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CWeb05Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_EXPLORER1, m_ctrlIE);
	DDX_Control(pDX, IDC_EDIT1, m_ctrlURL);
}

BEGIN_MESSAGE_MAP(CWeb05Dlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDOK, &CWeb05Dlg::OnBnClickedOk)
END_MESSAGE_MAP()


// CWeb05Dlg message handlers

BOOL CWeb05Dlg::OnInitDialog()
{
...
void CWeb05Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CWeb05Dlg::OnQueryDragIcon()
{
